...
- [ ] Peluncuran: komunitas dev Indonesia → ekosistem ACP/MCP → publik — belum dimulai pada 19 Agustus 2026. Registry, chip npm, `package.json`, dan judul teratas `CHANGELOG.md` sama-sama memegang `1.5.9`: pemilik menyetujui `npm publish` pada 19 Agustus 2026 dan registry mengonfirmasi tarball publiknya. Yang tersisa adalah peluncuran ke komunitas, satu-satunya langkah di baris ini yang tidak bisa dikerjakan dari repositori. Langkah pasca-rilis sejak keputusan pemilik 8 Agustus 2026
