...
export const PAGES: Record<PageKey, PageMeta> = {
  landing: {
    ...
    description:
      'Caraka v1.0 connects Telegram, Discord, or WhatsApp to the coding agent on your machine, with sessions, single-use approvals, secret scrubbing, and audit.',
  ...
  docs: {
    ...
    description:
      'Caraka documentation: the shipped v1.0 scope across three channels, architecture, session model, security controls, and roadmap.',
  ...
  install: {
    ...
    description:
      'Install Caraka v1.0 for private Telegram chat and Claude Code, by command or with a safe prompt for Codex and Claude.',
  ...
  status: {
    ...
    description:
      'Caraka v1.0 is unproven: every phase carries shipped code, and no field gate has been answered. See the phases, the open gates, and the release scope.',
