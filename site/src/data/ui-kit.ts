...
export const errorPages = [
  ...
  // Comp line 437 offers the Gemini free path; v0.2 needs an authenticated
  // Claude Code installation (docs/install-guide.md:14), so the empty state
  // names the agent that ships.
