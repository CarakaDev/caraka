...
export const errorPages = [
  ...
  // the seven agent binaries it scans PATH for, nine presets ship, and five have
  // run against a live binary here — Claude Code, Codex, aider, goose, and
  // opencode — so the empty state names the one with the shortest path to a
  // first message rather than listing nine a reader would have to choose
  // between.
