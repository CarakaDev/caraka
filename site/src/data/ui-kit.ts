...
export const errorPages = [
  ...
  // the seven presets it finds on PATH, but Claude Code is the only route ever
  // run against a live binary here, so the empty state names that one rather
  // than listing seven a reader would have to choose between.
