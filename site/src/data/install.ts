...
export const chain = [
  ...
  { n: '3', title: 'A coding agent, signed in', body: 'Claude Code over the official ACP adapter is the shortest route; init accepts any of the nine presets it finds on PATH, and five have run against a live binary here. Run claude auth status to confirm access.', range: r(2, 5, 28) },
]
