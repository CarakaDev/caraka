...
export const badges = [
  ...
  // touching this line. It gave `dist-tags.latest` 1.5.6 on 15 August 2026.
  { k: 'npm', v: 'v1.5.6', tone: '#E2452C', ink: '#FFEDE7' },
...
export const projects = [
  {
    ...
    // Comp line 271 says pre-alpha. 1.5.6 is the release in the CHANGELOG, and
